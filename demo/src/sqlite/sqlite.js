...
const { onAggregateFinalize, onAggregateStep, onAuthorize, onCollationCompare, onCommit, onRollback, onScalarFunction, onUpdate } = imports['sqlite:wasm/extension-callbacks'];
...
let gen = (function* _initGenerator () {
  ...
  function trampoline2(arg0) {
    _debugLog('[iface="sqlite:wasm/extension-callbacks@0.1.0", function="on-commit"] [Instruction::CallInterface] (async? sync, @ enter)');
    const _interface_call_currentTaskID = startCurrentTask(0, false, 'on-commit');
    const ret = onCommit(BigInt.asUintN(64, arg0));
    _debugLog('[iface="sqlite:wasm/extension-callbacks@0.1.0", function="on-commit"] [Instruction::CallInterface] (sync, @ post-call)');
    endCurrentTask(0);
    _debugLog('[iface="sqlite:wasm/extension-callbacks@0.1.0", function="on-commit"][Instruction::Return]', {
      funcName: 'on-commit',
      paramCount: 1,
      async: false,
      postReturn: false
  ...
  function trampoline3(arg0) {
    _debugLog('[iface="sqlite:wasm/extension-callbacks@0.1.0", function="on-rollback"] [Instruction::CallInterface] (async? sync, @ enter)');
    const _interface_call_currentTaskID = startCurrentTask(0, false, 'on-rollback');
    onRollback(BigInt.asUintN(64, arg0));
    _debugLog('[iface="sqlite:wasm/extension-callbacks@0.1.0", function="on-rollback"] [Instruction::CallInterface] (sync, @ post-call)');
    endCurrentTask(0);
    _debugLog('[iface="sqlite:wasm/extension-callbacks@0.1.0", function="on-rollback"][Instruction::Return]', {
      funcName: 'on-rollback',
      paramCount: 0,
      async: false,
      postReturn: false
    });
  ...
  function trampoline21(arg0, arg1, arg2, arg3) {
    ...
    for (let i = 0; i < len7; i++) {
      ...
      switch (dataView(memory0).getUint8(base + 0, true)) {
        ...
        default: {
          throw new TypeError('invalid discriminant specified for ValueType');
        }
      }
      let variant1;
      switch (dataView(memory0).getUint8(base + 8, true)) {
        ...
        case 1: {
          variant1 = dataView(memory0).getBigInt64(base + 16, true);
          break;
        }
        default: {
      ...
      switch (dataView(memory0).getUint8(base + 24, true)) {
        ...
        case 1: {
          variant2 = dataView(memory0).getFloat64(base + 32, true);
          break;
        }
        default: {
          throw new TypeError('invalid variant discriminant for option');
      ...
      switch (dataView(memory0).getUint8(base + 40, true)) {
        ...
        case 1: {
          var ptr3 = dataView(memory0).getUint32(base + 44, true);
          var len3 = dataView(memory0).getUint32(base + 48, true);
      ...
      switch (dataView(memory0).getUint8(base + 52, true)) {
        ...
        case 1: {
          var ptr5 = dataView(memory0).getUint32(base + 56, true);
          var len5 = dataView(memory0).getUint32(base + 60, true);
    ...
    _debugLog('[iface="sqlite:wasm/extension-callbacks@0.1.0", function="on-scalar-function"] [Instruction::CallInterface] (async? sync, @ enter)');
    const _interface_call_currentTaskID = startCurrentTask(0, false, 'on-scalar-function');
    let ret;
    try {
      ret = { tag: 'ok', val: onScalarFunction(BigInt.asUintN(64, arg0), result7)};
    } catch (e) {
      ret = { tag: 'err', val: getErrorPayload(e) };
    }
    _debugLog('[iface="sqlite:wasm/extension-callbacks@0.1.0", function="on-scalar-function"] [Instruction::CallInterface] (sync, @ post-call)');
    endCurrentTask(0);
    var variant17 = ret;
    switch (variant17.tag) {
      case 'ok': {
        ...
        var {valueType: v8_0, intValue: v8_1, floatValue: v8_2, textValue: v8_3, blobValue: v8_4 } = e;
        var val9 = v8_0;
        let enum9;
        switch (val9) {
          case 'integer': {
          ...
          default: {
            if ((v8_0) instanceof Error) {
              console.error(v8_0);
            }
            
            throw new TypeError(`"${val9}" is not one of the cases of value-type`);
          }
        }
        dataView(memory0).setInt8(arg3 + 8, enum9, true);
        var variant10 = v8_1;
        if (variant10 === null || variant10=== undefined) {
          ...
          dataView(memory0).setBigInt64(arg3 + 24, toInt64(e), true);
        }
        var variant11 = v8_2;
        if (variant11 === null || variant11=== undefined) {
          ...
          dataView(memory0).setFloat64(arg3 + 40, +e, true);
        }
        var variant13 = v8_3;
        if (variant13 === null || variant13=== undefined) {
          dataView(memory0).setInt8(arg3 + 48, 0, true);
        } else {
          const e = variant13;
          dataView(memory0).setInt8(arg3 + 48, 1, true);
          var ptr12 = utf8Encode(e, realloc0, memory0);
          var len12 = utf8EncodedLen;
          dataView(memory0).setUint32(arg3 + 56, len12, true);
          dataView(memory0).setUint32(arg3 + 52, ptr12, true);
        }
        var variant15 = v8_4;
        if (variant15 === null || variant15=== undefined) {
          dataView(memory0).setInt8(arg3 + 60, 0, true);
        } else {
          const e = variant15;
          dataView(memory0).setInt8(arg3 + 60, 1, true);
          var val14 = e;
          var len14 = val14.byteLength;
          var ptr14 = realloc0(0, 0, 1, len14 * 1);
          var src14 = new Uint8Array(val14.buffer || val14, val14.byteOffset, len14 * 1);
          (new Uint8Array(memory0.buffer, ptr14, len14 * 1)).set(src14);
          dataView(memory0).setUint32(arg3 + 68, len14, true);
          dataView(memory0).setUint32(arg3 + 64, ptr14, true);
        }
        break;
      }
      case 'err': {
        ...
        dataView(memory0).setUint32(arg3 + 12, len16, true);
        dataView(memory0).setUint32(arg3 + 8, ptr16, true);
        break;
      }
      default: {
    ...
    _debugLog('[iface="sqlite:wasm/extension-callbacks@0.1.0", function="on-scalar-function"][Instruction::Return]', {
      funcName: 'on-scalar-function',
      paramCount: 0,
      async: false,
      postReturn: false
    });
  ...
  function trampoline22(arg0, arg1, arg2, arg3) {
    ...
    _debugLog('[iface="sqlite:wasm/extension-callbacks@0.1.0", function="on-aggregate-step"] [Instruction::CallInterface] (async? sync, @ enter)');
    const _interface_call_currentTaskID = startCurrentTask(0, false, 'on-aggregate-step');
    onAggregateStep(BigInt.asUintN(64, arg0), BigInt.asUintN(64, arg1), result7);
    _debugLog('[iface="sqlite:wasm/extension-callbacks@0.1.0", function="on-aggregate-step"] [Instruction::CallInterface] (sync, @ post-call)');
    endCurrentTask(0);
    _debugLog('[iface="sqlite:wasm/extension-callbacks@0.1.0", function="on-aggregate-step"][Instruction::Return]', {
      funcName: 'on-aggregate-step',
      paramCount: 0,
      async: false,
      postReturn: false
    });
  ...
  function trampoline23(arg0, arg1, arg2) {
    _debugLog('[iface="sqlite:wasm/extension-callbacks@0.1.0", function="on-aggregate-finalize"] [Instruction::CallInterface] (async? sync, @ enter)');
    const _interface_call_currentTaskID = startCurrentTask(0, false, 'on-aggregate-finalize');
    let ret;
    try {
      ret = { tag: 'ok', val: onAggregateFinalize(BigInt.asUintN(64, arg0), BigInt.asUintN(64, arg1))};
    } catch (e) {
      ret = { tag: 'err', val: getErrorPayload(e) };
    }
    _debugLog('[iface="sqlite:wasm/extension-callbacks@0.1.0", function="on-aggregate-finalize"] [Instruction::CallInterface] (sync, @ post-call)');
    endCurrentTask(0);
    var variant9 = ret;
    switch (variant9.tag) {
      case 'ok': {
        ...
        var {valueType: v0_0, intValue: v0_1, floatValue: v0_2, textValue: v0_3, blobValue: v0_4 } = e;
        var val1 = v0_0;
        let enum1;
        switch (val1) {
          case 'integer': {
          ...
          default: {
            ...
            throw new TypeError(`"${val1}" is not one of the cases of value-type`);
          }
        }
        dataView(memory0).setInt8(arg2 + 8, enum1, true);
        var variant2 = v0_1;
        if (variant2 === null || variant2=== undefined) {
          dataView(memory0).setInt8(arg2 + 16, 0, true);
        } else {
          const e = variant2;
          dataView(memory0).setInt8(arg2 + 16, 1, true);
          dataView(memory0).setBigInt64(arg2 + 24, toInt64(e), true);
        }
        var variant3 = v0_2;
        if (variant3 === null || variant3=== undefined) {
          dataView(memory0).setInt8(arg2 + 32, 0, true);
        } else {
          const e = variant3;
          dataView(memory0).setInt8(arg2 + 32, 1, true);
          dataView(memory0).setFloat64(arg2 + 40, +e, true);
        }
        var variant5 = v0_3;
        if (variant5 === null || variant5=== undefined) {
          dataView(memory0).setInt8(arg2 + 48, 0, true);
        } else {
          const e = variant5;
          dataView(memory0).setInt8(arg2 + 48, 1, true);
          var ptr4 = utf8Encode(e, realloc0, memory0);
          var len4 = utf8EncodedLen;
          dataView(memory0).setUint32(arg2 + 56, len4, true);
          dataView(memory0).setUint32(arg2 + 52, ptr4, true);
        }
        var variant7 = v0_4;
        if (variant7 === null || variant7=== undefined) {
          dataView(memory0).setInt8(arg2 + 60, 0, true);
        } else {
          const e = variant7;
          dataView(memory0).setInt8(arg2 + 60, 1, true);
          var val6 = e;
          ...
          dataView(memory0).setUint32(arg2 + 68, len6, true);
          dataView(memory0).setUint32(arg2 + 64, ptr6, true);
        }
        break;
      }
      case 'err': {
        ...
        dataView(memory0).setUint32(arg2 + 8, ptr8, true);
        break;
      }
      default: {
        throw new TypeError('invalid variant specified for result');
    ...
    _debugLog('[iface="sqlite:wasm/extension-callbacks@0.1.0", function="on-aggregate-finalize"][Instruction::Return]', {
      funcName: 'on-aggregate-finalize',
      paramCount: 0,
      async: false,
      postReturn: false
    });
  ...
  function trampoline24(arg0, arg1, arg2, arg3, arg4) {
    ...
    _debugLog('[iface="sqlite:wasm/extension-callbacks@0.1.0", function="on-collation-compare"] [Instruction::CallInterface] (async? sync, @ enter)');
    const _interface_call_currentTaskID = startCurrentTask(0, false, 'on-collation-compare');
    const ret = onCollationCompare(BigInt.asUintN(64, arg0), result0, result1);
    _debugLog('[iface="sqlite:wasm/extension-callbacks@0.1.0", function="on-collation-compare"] [Instruction::CallInterface] (sync, @ post-call)');
    endCurrentTask(0);
    _debugLog('[iface="sqlite:wasm/extension-callbacks@0.1.0", function="on-collation-compare"][Instruction::Return]', {
      funcName: 'on-collation-compare',
      paramCount: 1,
      async: false,
      postReturn: false
    });
  ...
  function trampoline25(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
    ...
    switch (arg1) {
      ...
      default: {
        throw new TypeError('invalid discriminant specified for UpdateType');
      }
    }
    var ptr1 = arg2;
    var len1 = arg3;
    ...
    _debugLog('[iface="sqlite:wasm/extension-callbacks@0.1.0", function="on-update"] [Instruction::CallInterface] (async? sync, @ enter)');
    const _interface_call_currentTaskID = startCurrentTask(0, false, 'on-update');
    onUpdate(BigInt.asUintN(64, arg0), enum0, result1, result2, arg6);
    _debugLog('[iface="sqlite:wasm/extension-callbacks@0.1.0", function="on-update"] [Instruction::CallInterface] (sync, @ post-call)');
    endCurrentTask(0);
    _debugLog('[iface="sqlite:wasm/extension-callbacks@0.1.0", function="on-update"][Instruction::Return]', {
      funcName: 'on-update',
      paramCount: 0,
      async: false,
      postReturn: false
  ...
  function trampoline26(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13) {
    let enum0;
    switch (arg1) {
      case 0: {
        enum0 = 'create-index';
      ...
      case 2: {
        enum0 = 'create-temp-index';
        break;
      }
      case 3: {
        enum0 = 'create-temp-table';
        break;
      }
      case 4: {
        enum0 = 'create-temp-trigger';
        break;
      }
      case 5: {
        enum0 = 'create-temp-view';
        break;
      }
      case 6: {
        enum0 = 'create-trigger';
        break;
      }
      case 7: {
        enum0 = 'create-view';
      ...
      case 11: {
        enum0 = 'drop-temp-index';
        break;
      }
      case 12: {
        enum0 = 'drop-temp-table';
        break;
      }
      case 13: {
        enum0 = 'drop-temp-trigger';
        break;
      }
      case 14: {
        enum0 = 'drop-temp-view';
        break;
      }
      case 15: {
        enum0 = 'drop-trigger';
      ...
      default: {
        throw new TypeError('invalid discriminant specified for AuthAction');
      }
    }
    let variant2;
    switch (arg2) {
    ...
    _debugLog('[iface="sqlite:wasm/extension-callbacks@0.1.0", function="on-authorize"] [Instruction::CallInterface] (async? sync, @ enter)');
    const _interface_call_currentTaskID = startCurrentTask(0, false, 'on-authorize');
    const ret = onAuthorize(BigInt.asUintN(64, arg0), enum0, variant2, variant4, variant6, variant8);
    _debugLog('[iface="sqlite:wasm/extension-callbacks@0.1.0", function="on-authorize"] [Instruction::CallInterface] (sync, @ post-call)');
    endCurrentTask(0);
    var val9 = ret;
    let enum9;
    switch (val9) {
      ...
      default: {
        ...
        throw new TypeError(`"${val9}" is not one of the cases of auth-result`);
      }
    }
    _debugLog('[iface="sqlite:wasm/extension-callbacks@0.1.0", function="on-authorize"][Instruction::Return]', {
      funcName: 'on-authorize',
      paramCount: 1,
      async: false,
      postReturn: false
    });
  ...
  ({ exports: exports1 } = yield instantiateCore(yield module0, {
    ...
    'sqlite:wasm/extension-callbacks@0.1.0': {
      'on-aggregate-finalize': exports0['2'],
      'on-aggregate-step': exports0['1'],
      'on-authorize': exports0['5'],
      'on-collation-compare': exports0['3'],
      'on-commit': trampoline2,
      'on-rollback': trampoline3,
      'on-scalar-function': exports0['0'],
      'on-update': exports0['4'],
    },
    'wasi:io/poll@0.2.0': {
    ...
    wasi_snapshot_preview1: {
      adapter_close_badfd: exports0['21'],
  ...
  ({ exports: exports2 } = yield instantiateCore(yield module1, {
    ...
    'wasi:cli/terminal-stderr@0.2.0': {
      'get-terminal-stderr': exports0['48'],
    },
    'wasi:cli/terminal-stdin@0.2.0': {
      'get-terminal-stdin': exports0['46'],
    },
    'wasi:cli/terminal-stdout@0.2.0': {
      'get-terminal-stdout': exports0['47'],
    },
    ...
    'wasi:filesystem/types@0.2.0': {
      ...
      '[method]descriptor.get-flags': exports0['25'],
      '[method]descriptor.get-type': exports0['35'],
      '[method]descriptor.metadata-hash': exports0['37'],
      '[method]descriptor.metadata-hash-at': exports0['38'],
      '[method]descriptor.open-at': exports0['30'],
      '[method]descriptor.read-via-stream': exports0['32'],
      '[method]descriptor.set-size': exports0['26'],
      '[method]descriptor.stat': exports0['36'],
      '[method]descriptor.stat-at': exports0['29'],
      '[method]descriptor.sync': exports0['28'],
      ...
      '[resource-drop]directory-entry-stream': trampoline12,
    ...
    'wasi:io/streams@0.2.0': {
      ...
      '[method]output-stream.blocking-write-and-flush': exports0['44'],
  ...
  ({ exports: exports3 } = yield instantiateCore(yield module3, {
    '': {
      ...
      '21': exports2.adapter_close_badfd,
      '22': exports1['sqlite:wasm/high-level@0.1.0#[dtor]connection'],
      '23': exports1['sqlite:wasm/high-level@0.1.0#[dtor]statement'],
      '24': trampoline27,
      '25': trampoline28,
      '26': trampoline29,
      '27': trampoline30,
  ...
  postReturn27 = exports1['cabi_post_sqlite:wasm/extension@0.1.0#register-scalar-function'];
  postReturn28 = exports1['cabi_post_sqlite:wasm/extension@0.1.0#unregister-function'];
  postReturn29 = exports1['cabi_post_sqlite:wasm/extension@0.1.0#register-aggregate-function'];
  postReturn30 = exports1['cabi_post_sqlite:wasm/extension@0.1.0#register-collation'];
  postReturn31 = exports1['cabi_post_sqlite:wasm/extension@0.1.0#unregister-collation'];
  postReturn32 = exports1['cabi_post_sqlite:wasm/extension@0.1.0#set-update-hook'];
  postReturn33 = exports1['cabi_post_sqlite:wasm/extension@0.1.0#remove-update-hook'];
  postReturn34 = exports1['cabi_post_sqlite:wasm/extension@0.1.0#set-commit-hook'];
  postReturn35 = exports1['cabi_post_sqlite:wasm/extension@0.1.0#remove-commit-hook'];
  postReturn36 = exports1['cabi_post_sqlite:wasm/extension@0.1.0#set-rollback-hook'];
  postReturn37 = exports1['cabi_post_sqlite:wasm/extension@0.1.0#remove-rollback-hook'];
  postReturn38 = exports1['cabi_post_sqlite:wasm/extension@0.1.0#set-busy-timeout'];
  postReturn39 = exports1['cabi_post_sqlite:wasm/extension@0.1.0#set-authorizer'];
  postReturn40 = exports1['cabi_post_sqlite:wasm/extension@0.1.0#remove-authorizer'];
  let lowLevel010Open;
  ...
  class Connection{
    constructor(arg0, arg1) {
      ...
      Object.defineProperty(rsc2, symbolDispose, { writable: true, value: function () {
        ...
        exports0['22'](handleTable12[(handle3 << 1) + 1] & ~T_FLAG);
      }});
    ...
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
        ...
        Object.defineProperty(rsc3, symbolDispose, { writable: true, value: function () {
          ...
          exports0['23'](handleTable13[(handle4 << 1) + 1] & ~T_FLAG);
        }});
        variant6= {
          tag: 'ok',
          val: rsc3
    ...
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
        ...
        Object.defineProperty(rsc0, symbolDispose, { writable: true, value: function () {
          ...
          exports0['22'](handleTable12[(handle1 << 1) + 1] & ~T_FLAG);
        }});
        variant3= {
          tag: 'ok',
          val: rsc0
    ...
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
        ...
        Object.defineProperty(rsc1, symbolDispose, { writable: true, value: function () {
          ...
          exports0['22'](handleTable12[(handle2 << 1) + 1] & ~T_FLAG);
        }});
        variant4= {
          tag: 'ok',
          val: rsc1
  ...
  let extension010RegisterScalarFunction;
  
  function registerScalarFunction(arg0, arg1, arg2, arg3, arg4) {
    var ptr0 = utf8Encode(arg1, realloc0, memory0);
    var len0 = utf8EncodedLen;
    let flags1 = 0;
    if (typeof arg3 === 'object' && arg3 !== null) {
      flags1 = Boolean(arg3.deterministic) << 0 | Boolean(arg3.directOnly) << 1;
    } else if (arg3 !== null && arg3!== undefined) {
      throw new TypeError('only an object, undefined or null can be converted to flags');
    }
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="register-scalar-function"][Instruction::CallWasm] enter', {
      funcName: 'register-scalar-function',
      paramCount: 6,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'extension010RegisterScalarFunction');
    const ret = extension010RegisterScalarFunction(toUint64(arg0), ptr0, len0, toInt32(arg2), flags1, toUint64(arg4));
    endCurrentTask(0);
    let variant3;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="register-scalar-function"][Instruction::Return]', {
      funcName: 'register-scalar-function',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let extension010UnregisterFunction;
  
  function unregisterFunction(arg0) {
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="unregister-function"][Instruction::CallWasm] enter', {
      funcName: 'unregister-function',
      paramCount: 1,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'extension010UnregisterFunction');
    const ret = extension010UnregisterFunction(toUint64(arg0));
    endCurrentTask(0);
    let variant1;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="unregister-function"][Instruction::Return]', {
      funcName: 'unregister-function',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let extension010RegisterAggregateFunction;
  
  function registerAggregateFunction(arg0, arg1, arg2, arg3, arg4) {
    var ptr0 = utf8Encode(arg1, realloc0, memory0);
    var len0 = utf8EncodedLen;
    let flags1 = 0;
    if (typeof arg3 === 'object' && arg3 !== null) {
    ...
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="register-aggregate-function"][Instruction::CallWasm] enter', {
      funcName: 'register-aggregate-function',
      paramCount: 6,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'extension010RegisterAggregateFunction');
    const ret = extension010RegisterAggregateFunction(toUint64(arg0), ptr0, len0, toInt32(arg2), flags1, toUint64(arg4));
    endCurrentTask(0);
    let variant3;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="register-aggregate-function"][Instruction::Return]', {
      funcName: 'register-aggregate-function',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let extension010RegisterCollation;
  
  function registerCollation(arg0, arg1, arg2) {
    var ptr0 = utf8Encode(arg1, realloc0, memory0);
    var len0 = utf8EncodedLen;
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="register-collation"][Instruction::CallWasm] enter', {
      funcName: 'register-collation',
      paramCount: 4,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'extension010RegisterCollation');
    const ret = extension010RegisterCollation(toUint64(arg0), ptr0, len0, toUint64(arg2));
    endCurrentTask(0);
    let variant2;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="register-collation"][Instruction::Return]', {
      funcName: 'register-collation',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let extension010UnregisterCollation;
  
  function unregisterCollation(arg0) {
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="unregister-collation"][Instruction::CallWasm] enter', {
      funcName: 'unregister-collation',
      paramCount: 1,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'extension010UnregisterCollation');
    const ret = extension010UnregisterCollation(toUint64(arg0));
    endCurrentTask(0);
    let variant1;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="unregister-collation"][Instruction::Return]', {
      funcName: 'unregister-collation',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let extension010SetUpdateHook;
  
  function setUpdateHook(arg0, arg1) {
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="set-update-hook"][Instruction::CallWasm] enter', {
      funcName: 'set-update-hook',
      paramCount: 2,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'extension010SetUpdateHook');
    const ret = extension010SetUpdateHook(toUint64(arg0), toUint64(arg1));
    endCurrentTask(0);
    let variant1;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="set-update-hook"][Instruction::Return]', {
      funcName: 'set-update-hook',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let extension010RemoveUpdateHook;
  
  function removeUpdateHook(arg0) {
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="remove-update-hook"][Instruction::CallWasm] enter', {
      funcName: 'remove-update-hook',
      paramCount: 1,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'extension010RemoveUpdateHook');
    const ret = extension010RemoveUpdateHook(toUint64(arg0));
    endCurrentTask(0);
    let variant1;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="remove-update-hook"][Instruction::Return]', {
      funcName: 'remove-update-hook',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let extension010SetCommitHook;
  
  function setCommitHook(arg0, arg1) {
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="set-commit-hook"][Instruction::CallWasm] enter', {
      funcName: 'set-commit-hook',
      paramCount: 2,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'extension010SetCommitHook');
    const ret = extension010SetCommitHook(toUint64(arg0), toUint64(arg1));
    endCurrentTask(0);
    let variant1;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="set-commit-hook"][Instruction::Return]', {
      funcName: 'set-commit-hook',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let extension010RemoveCommitHook;
  
  function removeCommitHook(arg0) {
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="remove-commit-hook"][Instruction::CallWasm] enter', {
      funcName: 'remove-commit-hook',
      paramCount: 1,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'extension010RemoveCommitHook');
    const ret = extension010RemoveCommitHook(toUint64(arg0));
    endCurrentTask(0);
    let variant1;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="remove-commit-hook"][Instruction::Return]', {
      funcName: 'remove-commit-hook',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let extension010SetRollbackHook;
  
  function setRollbackHook(arg0, arg1) {
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="set-rollback-hook"][Instruction::CallWasm] enter', {
      funcName: 'set-rollback-hook',
      paramCount: 2,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'extension010SetRollbackHook');
    const ret = extension010SetRollbackHook(toUint64(arg0), toUint64(arg1));
    endCurrentTask(0);
    let variant1;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="set-rollback-hook"][Instruction::Return]', {
      funcName: 'set-rollback-hook',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let extension010RemoveRollbackHook;
  
  function removeRollbackHook(arg0) {
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="remove-rollback-hook"][Instruction::CallWasm] enter', {
      funcName: 'remove-rollback-hook',
      paramCount: 1,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'extension010RemoveRollbackHook');
    const ret = extension010RemoveRollbackHook(toUint64(arg0));
    endCurrentTask(0);
    let variant1;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="remove-rollback-hook"][Instruction::Return]', {
      funcName: 'remove-rollback-hook',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let extension010SetBusyTimeout;
  
  function setBusyTimeout(arg0, arg1) {
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="set-busy-timeout"][Instruction::CallWasm] enter', {
      funcName: 'set-busy-timeout',
      paramCount: 2,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'extension010SetBusyTimeout');
    const ret = extension010SetBusyTimeout(toUint64(arg0), toInt32(arg1));
    endCurrentTask(0);
    let variant1;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="set-busy-timeout"][Instruction::Return]', {
      funcName: 'set-busy-timeout',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let extension010SetAuthorizer;
  
  function setAuthorizer(arg0, arg1) {
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="set-authorizer"][Instruction::CallWasm] enter', {
      funcName: 'set-authorizer',
      paramCount: 2,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'extension010SetAuthorizer');
    const ret = extension010SetAuthorizer(toUint64(arg0), toUint64(arg1));
    endCurrentTask(0);
    let variant1;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="set-authorizer"][Instruction::Return]', {
      funcName: 'set-authorizer',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  let extension010RemoveAuthorizer;
  
  function removeAuthorizer(arg0) {
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="remove-authorizer"][Instruction::CallWasm] enter', {
      funcName: 'remove-authorizer',
      paramCount: 1,
      async: false,
      postReturn: true,
    });
    const _wasm_call_currentTaskID = startCurrentTask(0, false, 'extension010RemoveAuthorizer');
    const ret = extension010RemoveAuthorizer(toUint64(arg0));
    endCurrentTask(0);
    let variant1;
    switch (dataView(memory0).getUint8(ret + 0, true)) {
      case 0: {
    ...
    _debugLog('[iface="sqlite:wasm/extension@0.1.0", function="remove-authorizer"][Instruction::Return]', {
      funcName: 'remove-authorizer',
      paramCount: 1,
      async: false,
      postReturn: true
  ...
  extension010RegisterScalarFunction = exports1['sqlite:wasm/extension@0.1.0#register-scalar-function'];
  extension010UnregisterFunction = exports1['sqlite:wasm/extension@0.1.0#unregister-function'];
  extension010RegisterAggregateFunction = exports1['sqlite:wasm/extension@0.1.0#register-aggregate-function'];
  extension010RegisterCollation = exports1['sqlite:wasm/extension@0.1.0#register-collation'];
  extension010UnregisterCollation = exports1['sqlite:wasm/extension@0.1.0#unregister-collation'];
  extension010SetUpdateHook = exports1['sqlite:wasm/extension@0.1.0#set-update-hook'];
  extension010RemoveUpdateHook = exports1['sqlite:wasm/extension@0.1.0#remove-update-hook'];
  extension010SetCommitHook = exports1['sqlite:wasm/extension@0.1.0#set-commit-hook'];
  extension010RemoveCommitHook = exports1['sqlite:wasm/extension@0.1.0#remove-commit-hook'];
  extension010SetRollbackHook = exports1['sqlite:wasm/extension@0.1.0#set-rollback-hook'];
  extension010RemoveRollbackHook = exports1['sqlite:wasm/extension@0.1.0#remove-rollback-hook'];
  extension010SetBusyTimeout = exports1['sqlite:wasm/extension@0.1.0#set-busy-timeout'];
  extension010SetAuthorizer = exports1['sqlite:wasm/extension@0.1.0#set-authorizer'];
  extension010RemoveAuthorizer = exports1['sqlite:wasm/extension@0.1.0#remove-authorizer'];
  const extension010 = {
    registerAggregateFunction: registerAggregateFunction,
    registerCollation: registerCollation,
    registerScalarFunction: registerScalarFunction,
    removeAuthorizer: removeAuthorizer,
    removeCommitHook: removeCommitHook,
    removeRollbackHook: removeRollbackHook,
    removeUpdateHook: removeUpdateHook,
    setAuthorizer: setAuthorizer,
    setBusyTimeout: setBusyTimeout,
    setCommitHook: setCommitHook,
    setRollbackHook: setRollbackHook,
    setUpdateHook: setUpdateHook,
    unregisterCollation: unregisterCollation,
  ...
  return { extension: extension010, highLevel: highLevel010, lowLevel: lowLevel010, 'sqlite:wasm/extension@0.1.0': extension010, 'sqlite:wasm/high-level@0.1.0': highLevel010, 'sqlite:wasm/low-level@0.1.0': lowLevel010,  };
})();
