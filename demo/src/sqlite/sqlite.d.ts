...
import type * as SqliteWasmExtensionCallbacks from './interfaces/sqlite-wasm-extension-callbacks.js'; // sqlite:wasm/extension-callbacks@0.1.0
import type * as SqliteWasmExtension from './interfaces/sqlite-wasm-extension.js'; // sqlite:wasm/extension@0.1.0
...
export interface ImportObject {
  'sqlite:wasm/extension-callbacks@0.1.0': typeof SqliteWasmExtensionCallbacks,
  'sqlite:wasm/extension@0.1.0': typeof SqliteWasmExtension,
...
export interface Root {
  ...
  'sqlite:wasm/extension@0.1.0': typeof SqliteWasmExtension,
  extension: typeof SqliteWasmExtension,
}
