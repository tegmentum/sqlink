...
bool exports_sqlink_wasm_low_level_open(sqlite_world_string_t *filename, exports_sqlink_wasm_low_level_open_flags_t open_flags, exports_sqlink_wasm_low_level_db_handle_t *ret, exports_sqlink_wasm_low_level_result_code_t *err);
...
bool exports_sqlink_wasm_low_level_exec(exports_sqlink_wasm_low_level_db_handle_t db, sqlite_world_string_t *sql, sqlite_world_string_t *ret, exports_sqlink_wasm_low_level_result_code_t *err);
bool exports_sqlink_wasm_low_level_prepare(exports_sqlink_wasm_low_level_db_handle_t db, sqlite_world_string_t *sql, exports_sqlink_wasm_low_level_stmt_handle_t *ret, exports_sqlink_wasm_low_level_result_code_t *err);
...
exports_sqlink_wasm_low_level_result_code_t exports_sqlink_wasm_low_level_bind_text(exports_sqlink_wasm_low_level_stmt_handle_t stmt, int32_t index, sqlite_world_string_t *value);
exports_sqlink_wasm_low_level_result_code_t exports_sqlink_wasm_low_level_bind_blob(exports_sqlink_wasm_low_level_stmt_handle_t stmt, int32_t index, sqlite_world_list_u8_t *value);
int32_t exports_sqlink_wasm_low_level_bind_parameter_count(exports_sqlink_wasm_low_level_stmt_handle_t stmt);
int32_t exports_sqlink_wasm_low_level_bind_parameter_index(exports_sqlink_wasm_low_level_stmt_handle_t stmt, sqlite_world_string_t *name);
...
void exports_sqlink_wasm_low_level_column_name(exports_sqlink_wasm_low_level_stmt_handle_t stmt, int32_t index, sqlite_world_string_t *ret);
...
void exports_sqlink_wasm_low_level_column_text(exports_sqlink_wasm_low_level_stmt_handle_t stmt, int32_t index, sqlite_world_string_t *ret);
void exports_sqlink_wasm_low_level_column_blob(exports_sqlink_wasm_low_level_stmt_handle_t stmt, int32_t index, sqlite_world_list_u8_t *ret);
int32_t exports_sqlink_wasm_low_level_column_bytes(exports_sqlink_wasm_low_level_stmt_handle_t stmt, int32_t index);
void exports_sqlink_wasm_low_level_errmsg(exports_sqlink_wasm_low_level_db_handle_t db, sqlite_world_string_t *ret);
...
exports_sqlink_wasm_high_level_own_connection_t exports_sqlink_wasm_high_level_constructor_connection(sqlite_world_string_t *path, exports_sqlink_wasm_high_level_open_mode_t mode);
bool exports_sqlink_wasm_high_level_method_connection_execute(exports_sqlink_wasm_high_level_borrow_connection_t self, sqlite_world_string_t *sql, exports_sqlink_wasm_high_level_exec_result_t *ret, exports_sqlink_wasm_high_level_database_error_t *err);
bool exports_sqlink_wasm_high_level_method_connection_execute_with_params(exports_sqlink_wasm_high_level_borrow_connection_t self, sqlite_world_string_t *sql, exports_sqlink_wasm_high_level_list_value_t *params, exports_sqlink_wasm_high_level_exec_result_t *ret, exports_sqlink_wasm_high_level_database_error_t *err);
bool exports_sqlink_wasm_high_level_method_connection_query(exports_sqlink_wasm_high_level_borrow_connection_t self, sqlite_world_string_t *sql, exports_sqlink_wasm_high_level_query_result_t *ret, exports_sqlink_wasm_high_level_database_error_t *err);
bool exports_sqlink_wasm_high_level_method_connection_query_with_params(exports_sqlink_wasm_high_level_borrow_connection_t self, sqlite_world_string_t *sql, exports_sqlink_wasm_high_level_list_value_t *params, exports_sqlink_wasm_high_level_query_result_t *ret, exports_sqlink_wasm_high_level_database_error_t *err);
bool exports_sqlink_wasm_high_level_method_connection_prepare(exports_sqlink_wasm_high_level_borrow_connection_t self, sqlite_world_string_t *sql, exports_sqlink_wasm_high_level_own_statement_t *ret, exports_sqlink_wasm_high_level_database_error_t *err);
...
void exports_sqlink_wasm_high_level_method_statement_column_names(exports_sqlink_wasm_high_level_borrow_statement_t self, sqlite_world_list_string_t *ret);
...
bool exports_sqlink_wasm_high_level_open_file(sqlite_world_string_t *path, exports_sqlink_wasm_high_level_own_connection_t *ret, exports_sqlink_wasm_high_level_database_error_t *err);
