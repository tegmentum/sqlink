#!/usr/bin/env bash
# Build the auth handler into a component-shaped .wasm.
...
cargo build --release
SRC=target/wasm32-wasip2/release/wasm_auth_handler.wasm
OUT=target/wasm32-wasip2/release/wasm_auth_handler.component.wasm
