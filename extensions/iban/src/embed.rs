...
const SCALARS: &[ScalarSpec] = &[
    ScalarSpec { func_id: FID_VALIDATE,  name: b"iban_validate\0",     num_args: 1, deterministic: true },
    ScalarSpec { func_id: FID_NORMALIZE, name: b"iban_normalize\0",    num_args: 1, deterministic: true },
    ScalarSpec { func_id: FID_COUNTRY,   name: b"iban_country\0",      num_args: 1, deterministic: true },
    ScalarSpec { func_id: FID_CHECK,     name: b"iban_check_digits\0", num_args: 1, deterministic: true },
    ScalarSpec { func_id: FID_BBAN,      name: b"iban_bban\0",         num_args: 1, deterministic: true },
    ScalarSpec { func_id: FID_FORMAT,    name: b"iban_format\0",       num_args: 1, deterministic: true },
];
