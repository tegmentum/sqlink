//! `ean` — THIN, GENERATED sqlink (`sqlite:extension`) shim.
//!
...
//! in datalink `ean-core`; the registration ABI, func-id dispatch, and
...
mod wasm_export {
    ...
    datalink_extcore::sqlite_shim! {
        ...
        prefix_expansion = "com.tegmentum.sqlink.ext.ean";
    }
}
