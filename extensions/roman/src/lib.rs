//! `roman` — THIN, GENERATED sqlink (`sqlite:extension`) shim.
//!
...
//! in datalink `roman-core`; the registration ABI, func-id dispatch, and
...
mod wasm_export {
    ...
    datalink_extcore::sqlite_shim! {
        ...
        prefix_expansion = "com.tegmentum.sqlink.ext.roman";
    }
}
