...
const SCALARS: &[ScalarSpec] = &[
    ScalarSpec { func_id: FID_SNAKE,     name: b"to_snake_case\0",      num_args: 1, deterministic: true },
    ScalarSpec { func_id: FID_KEBAB,     name: b"to_kebab_case\0",      num_args: 1, deterministic: true },
    ScalarSpec { func_id: FID_CAMEL,     name: b"to_camel_case\0",      num_args: 1, deterministic: true },
    ScalarSpec { func_id: FID_PASCAL,    name: b"to_pascal_case\0",     num_args: 1, deterministic: true },
    ScalarSpec { func_id: FID_SCR_SNAKE, name: b"to_screaming_snake\0", num_args: 1, deterministic: true },
    ScalarSpec { func_id: FID_SCR_KEBAB, name: b"to_screaming_kebab\0", num_args: 1, deterministic: true },
    ScalarSpec { func_id: FID_TITLE,     name: b"to_title_case\0",      num_args: 1, deterministic: true },
    ScalarSpec { func_id: FID_TRAIN,     name: b"to_train_case\0",      num_args: 1, deterministic: true },
];
