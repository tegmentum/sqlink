...
const SCALARS: &[ScalarSpec] = &[
    ScalarSpec { func_id: FID_IEEE754,           name: b"ieee754\0",           num_args: 2, deterministic: true },
    ScalarSpec { func_id: FID_IEEE754_MANTISSA,  name: b"ieee754_mantissa\0",  num_args: 1, deterministic: true },
    ScalarSpec { func_id: FID_IEEE754_EXPONENT,  name: b"ieee754_exponent\0",  num_args: 1, deterministic: true },
    ScalarSpec { func_id: FID_IEEE754_FROM_BLOB, name: b"ieee754_from_blob\0", num_args: 1, deterministic: true },
    ScalarSpec { func_id: FID_IEEE754_TO_BLOB,   name: b"ieee754_to_blob\0",   num_args: 1, deterministic: true },
];
