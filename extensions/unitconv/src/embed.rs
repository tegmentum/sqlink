...
const SCALARS: &[ScalarSpec] = &[
    ScalarSpec { func_id: FID_LENGTH, name: b"conv_length\0",      num_args: 3, deterministic: true },
    ScalarSpec { func_id: FID_MASS,   name: b"conv_mass\0",        num_args: 3, deterministic: true },
    ScalarSpec { func_id: FID_TEMP,   name: b"conv_temperature\0", num_args: 3, deterministic: true },
    ScalarSpec { func_id: FID_TIME,   name: b"conv_time\0",        num_args: 3, deterministic: true },
    ScalarSpec { func_id: FID_DATA,   name: b"conv_data\0",        num_args: 3, deterministic: true },
];
