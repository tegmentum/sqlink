...
fn cmp_values(a: &SqlValueOwned, b: &SqlValueOwned) -> core::cmp::Ordering {
    ...
    match (a, b) {
        ...
        (SqlValueOwned::Real(x), SqlValueOwned::Real(y)) => x.partial_cmp(y).unwrap_or(Ordering::Equal),
        (SqlValueOwned::Integer(x), SqlValueOwned::Real(y)) => (*x as f64).partial_cmp(y).unwrap_or(Ordering::Equal),
        (SqlValueOwned::Real(x), SqlValueOwned::Integer(y)) => x.partial_cmp(&(*y as f64)).unwrap_or(Ordering::Equal),
...
const SCALARS: &[ScalarSpec] = &[
    ScalarSpec { func_id: FID_GREATEST,         name: b"greatest\0",         num_args: -1, deterministic: true },
    ScalarSpec { func_id: FID_LEAST,            name: b"least\0",            num_args: -1, deterministic: true },
    ScalarSpec { func_id: FID_LEFT,             name: b"left\0",             num_args:  2, deterministic: true },
    ScalarSpec { func_id: FID_RIGHT,            name: b"right\0",            num_args:  2, deterministic: true },
    ScalarSpec { func_id: FID_LPAD_2,           name: b"lpad\0",             num_args:  2, deterministic: true },
    ScalarSpec { func_id: FID_LPAD_3,           name: b"lpad\0",             num_args:  3, deterministic: true },
    ScalarSpec { func_id: FID_RPAD_2,           name: b"rpad\0",             num_args:  2, deterministic: true },
    ScalarSpec { func_id: FID_RPAD_3,           name: b"rpad\0",             num_args:  3, deterministic: true },
    ScalarSpec { func_id: FID_REPEAT,           name: b"repeat\0",           num_args:  2, deterministic: true },
    ScalarSpec { func_id: FID_SPACE,            name: b"space\0",            num_args:  1, deterministic: true },
    ScalarSpec { func_id: FID_STARTS_WITH,      name: b"starts_with\0",      num_args:  2, deterministic: true },
    ScalarSpec { func_id: FID_ENDS_WITH,        name: b"ends_with\0",        num_args:  2, deterministic: true },
    ScalarSpec { func_id: FID_TRANSLATE,        name: b"translate\0",        num_args:  3, deterministic: true },
    ScalarSpec { func_id: FID_TO_HEX,           name: b"to_hex\0",           num_args:  1, deterministic: true },
    ScalarSpec { func_id: FID_BIT_LENGTH,       name: b"bit_length\0",       num_args:  1, deterministic: true },
    ScalarSpec { func_id: FID_INITCAP,          name: b"initcap\0",          num_args:  1, deterministic: true },
    ScalarSpec { func_id: FID_IF,               name: b"if\0",               num_args:  3, deterministic: true },
    ScalarSpec { func_id: FID_CHR,              name: b"chr\0",              num_args:  1, deterministic: true },
    ScalarSpec { func_id: FID_ASCII,            name: b"ascii\0",            num_args:  1, deterministic: true },
    ScalarSpec { func_id: FID_CHAR_LENGTH,      name: b"char_length\0",      num_args:  1, deterministic: true },
    ScalarSpec { func_id: FID_CHARACTER_LENGTH, name: b"character_length\0", num_args:  1, deterministic: true },
    ScalarSpec { func_id: FID_FROM_HEX,         name: b"from_hex\0",         num_args:  1, deterministic: true },
];
