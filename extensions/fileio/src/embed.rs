...
const SCALARS: &[ScalarSpec] = &[
    ScalarSpec { func_id: FID_READFILE,    name: b"readfile\0",       num_args: 1, deterministic: false },
    ScalarSpec { func_id: FID_WRITEFILE,   name: b"writefile\0",      num_args: 2, deterministic: false },
    ScalarSpec { func_id: FID_APPENDFILE,  name: b"appendfile\0",     num_args: 2, deterministic: false },
    ScalarSpec { func_id: FID_FILE_EXISTS, name: b"file_exists\0",    num_args: 1, deterministic: false },
    ScalarSpec { func_id: FID_FILE_SIZE,   name: b"file_size\0",      num_args: 1, deterministic: false },
    ScalarSpec { func_id: FID_FILE_IS_DIR, name: b"file_is_dir\0",    num_args: 1, deterministic: false },
    ScalarSpec { func_id: FID_VERSION,     name: b"fileio_version\0", num_args: 0, deterministic: false },
];
