...
const SCALARS: &[ScalarSpec] = &[
    ScalarSpec { func_id: FID_VALIDATE,      name: b"phone_validate\0",      num_args: 2, deterministic: true },
    ScalarSpec { func_id: FID_E164,          name: b"phone_e164\0",          num_args: 2, deterministic: true },
    ScalarSpec { func_id: FID_INTERNATIONAL, name: b"phone_international\0", num_args: 2, deterministic: true },
    ScalarSpec { func_id: FID_NATIONAL,      name: b"phone_national\0",      num_args: 2, deterministic: true },
    ScalarSpec { func_id: FID_COUNTRY,       name: b"phone_country\0",       num_args: 2, deterministic: true },
    ScalarSpec { func_id: FID_REGION,        name: b"phone_region\0",        num_args: 2, deterministic: true },
];
