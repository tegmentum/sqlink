...
/// Phase B.4 of the S2 wasmos migration: reentrant `HostImports`
/// handler for `sqlite:extension/loader-bridge` — 6 methods over
...
/// handler for `sqlite:extension/session@1.0.0` — 9 methods over
/// the SQLite changeset/session FFI. Retires the
...
/// — 35 methods that mediate scalar / aggregate / collation /
/// authorize / hooks / vtab calls between the guest and loaded
