#!/usr/bin/env bash
# Build the SQL handler into a component-shaped .wasm.
...
cargo build --release
SRC=target/wasm32-wasip2/release/wasm_sql_handler.wasm
OUT=target/wasm32-wasip2/release/wasm_sql_handler.component.wasm
