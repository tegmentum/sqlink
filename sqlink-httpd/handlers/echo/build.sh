#!/usr/bin/env bash
# Build the echo handler into a component-shaped .wasm.
#
...
#   wasm_echo_handler.wasm            core module (intermediate)
#   wasm_echo_handler.component.wasm  the component you --load
set -euo pipefail
cd "$(dirname "$0")"
...
cargo build --release
SRC=target/wasm32-wasip2/release/wasm_echo_handler.wasm
OUT=target/wasm32-wasip2/release/wasm_echo_handler.component.wasm
